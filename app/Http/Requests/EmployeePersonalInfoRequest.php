...
class EmployeePersonalInfoRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'phone.regex' => 'Phone number must be in valid format (e.g., +1234567890). Only numbers allowed, optionally starting with +',
            'phone.max' => 'Phone number must not exceed 20 characters',
            'emergency_phone.regex' => 'Emergency phone must be in valid format (e.g., +1234567890). Only numbers allowed, optionally starting with +',
